...
A personal fork of AnkiConnect adding bulk note and scheduler actions, image-occlusion, image-crop, card-render, slim-note-read, media-thumbnail, revlog, backup, deck-export, AnkiWeb-sync (`syncStatus`/`syncNow`), and AnkiHub-suggestion actions, served on port **8766**.
